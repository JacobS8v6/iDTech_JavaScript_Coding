...
function checkPoint3(){
    ...
    function superMarket(cash) {
        ...
        const total = milk + vegetables + bread; //const added
        var cash = totalCash - total; //added var

        return cash;
    }

    function main() {
        let moneySpent = superMarket(); //add 'total' instead of just '()'? If I do this, I need to make 'total' a const
        return moneySpent;
    }
